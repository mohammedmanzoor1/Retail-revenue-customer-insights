...
Steps:
Loaded the raw transaction data in Python and explored its structure
Performed exploratory data analysis (EDA) on revenue, orders, products, and customers
...
Engineered new features: Revenue (Quantity × Price), OrderType (Retail/Wholesale), IsCancellation
Loaded the cleaned data into SQL Server and ran queries to answer 7 business questions
Built an interactive Tableau dashboard with KPI cards and filters
Summarized insights into a written report
...
Load the raw transaction CSV in Python and run the cleaning/feature-engineering script
Load the cleaned data into SQL Server and run the provided analysis queries
Connect Tableau to the SQL Server output and open the dashboard workbook (.twbx)
Refer to the PDF report and Gamma slides for full findings and recommendations
